...
pub contract WnWAlphaPacks: FungibleToken, TradingFungiblePack{
    ...
    pub struct AlphaPackInfo: TradingFungiblePack.PackInfo{
        ...
        init(setID: UInt32, packRaritiesDistribution: {UInt8: UFix64}, price: UFix64){
            ...
            for rarity in packRaritiesDistribution.keys{
                ...
                TF.isNumberInteger(sheetsPrintingSize) ?? panic("Bad pack rarity distribution for the set rarity distribution. See TNFCG Game Designer Help")
    ...
    pub resource PackOpener: TradingFungiblePack.PackOpener{
        ...
        pub fun openPacks(packsToOpen: @FungibleToken.Vault, owner: Address){
            ...
            packFulfilerRef.fulfilPacks(setID: WnWAlphaPacks.setID, packID: WnWAlphaPacks.TFPackInfo.packID, amount: packsToOpen.balance, owner: owner)
